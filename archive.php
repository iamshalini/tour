...
$category = get_queried_object();
 ...
 $imge = get_field('cat_banner_image', 'category_'.$cat_id); 
if(!empty($imge)){
	$img = $imge;	
}else{
	$img = "http://reservemytours.com/wp-content/uploads/2021/06/about-page-banner.jpg";
}
?>
...
<section>
	<div class="section">
		<div class="container">
			<div class="commonHeading"><strong></strong> <?php echo single_term_title(); ?></div>
			<div class="row">
