...
if(!empty($_GET['location'])){
 $url = get_permalink($_GET['location']);
 wp_redirect( $url );
 exit;
}else{
get_header();
	...
	<div class="section packageouter">
		<div class="container">
			...
			<?php while ( $query_post->have_posts()) {
              ...
              ?>
				<div class="col-md-4 col-12" data-id="<?php echo get_field('country'); ?>">
		...
		<div class="book-now-pop">
			<button type="button" class="LoadmoreBtn commonButton">Load More <img class="loader_image1" src="<?php echo site_url(); ?>/wp-content/uploads/2021/08/loader-white.gif" alt="" width="20" height="20" style="display:none;"></button></div>
		</div>
	<?php } ?>
		</div>
	</div>
