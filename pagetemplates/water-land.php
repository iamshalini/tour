...
<section>
	<div class="section packageouter">
		<div class="container">
			<div class="commonHeading"><strong>All</strong> <?php the_title(); ?></div>
			<?php 
			$arg = array('post_type'=>'water_tour','posts_per_page'=>get_option('posts_per_page'),'post_status'=>'publish'); 
